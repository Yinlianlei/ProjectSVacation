...
def get_args():
    ...
    parser.add_argument('-client_secret', type=str, default='559733d2f1894372b25cd77002a42af6')
    parser.add_argument('-client_id', type=str, default='129ed2c007bb43a19f93137d34ad62f2')
    parser.add_argument('-file_path', type=str, default='D:/大学生活/大三/大三下/实训/语音/1.wav')
